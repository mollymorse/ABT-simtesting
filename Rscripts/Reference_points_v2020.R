################################################################################################
################### BLUEFIN TUNA SIMULATIONS - CALCULATING REFERENCE POINTS ####################
######################################### Version 2020 #########################################
################################################################################################

# DESCRIPTION
# This code is meant to calculate reference points on the VPA outputs of the simulations, i.e., from existing Results files
# using own code for calculating YPR (as opposed to using ypr() function from fishmethods package)
